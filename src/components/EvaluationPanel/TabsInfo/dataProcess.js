  ...
  pushAllClass() {
    this.allData.push({
      ...
      grpah: {
        ...
        distFromLine: null,
        // distFromLine: if(metric['distFromLine']) {[...this.metric['distFromLine']]
...
class RegressionModel extends BaseModel {
  ...
  createC3Data_AllClass() {
    let dataArray = [];
    dataArray.push(['inde_x_axis', ...this.metric['inde_x_axis']]);
    dataArray.push(['dependent_y_axis', ...this.metric['dependent_y_axis']]);
    dataArray.push(['line_x_axis', ...this.metric['line_x_axis']]);
    dataArray.push(['line', ...this.metric['line']]);
    return dataArray;
  }
