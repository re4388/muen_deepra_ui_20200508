    ...
    <template>
      <div class="right__sideMenu">
        ...
        <div class="data__set">
          ...
          <div class="img__dataSet" onclick="ToggleNavigationPanel()"><img src="../../assets/dataset-2-img.png"></div>
        </div>
      ...
      <div class="box">
        <div class="title" id="navigation-panel" tabindex="-1" onblur="HideNavigationPanel()">
            <div class="imgList">
              <ul>
                <li>
